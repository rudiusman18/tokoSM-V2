...
class DataProduct {
  ...
  DataProduct.fromJson(Map<String, dynamic> json) {
    ...
    grosirJumlahMin =
        (json['grosir_jumlah_min'] as List?)?.map((e) => e).toList();
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'grosir_jumlah_min': grosirJumlahMin,
